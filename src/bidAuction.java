	...
	protected void doPost(HttpServletRequest request,
		...
		case 2:
			...
			out.println("<p>" + auction.getDescription()
					+ "</p><br><b>More Details:</b><br><br>");

			if (auction.getSold() == 1) {
				long leftTime = auction.getAuctionTime().getTime()- System.currentTimeMillis();
				out.println("<table border=\"0\" align=\"center\">"
						...
						+ "<tr><td>Time Left:   </td>"
						+ "<td>"
						+ MyUtils.getDay(leftTime)
						+ " Days " + MyUtils.getHour(leftTime) +" Hours "
						+ MyUtils.getMinute(leftTime)+" Minutes " 
						+ MyUtils.getSecond(leftTime)+" Seconds " 
						+ "</td>"
						+ "</tr>"
